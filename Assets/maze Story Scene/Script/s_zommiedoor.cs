...
public class s_zommiedoor : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject enemyPrefab = Instantiate(StoryManager.Instance.EnemyPrefab, SpawnPoint);
       // Game_Manager.Instance.ZombieDoors.Add(this);
       // enemyPrefab.GetComponent<s_enemy>().isPatrolDoor = true;
       // enemyPrefab.GetComponent<s_enemy>().patrolPoints = doorPatrolPoints;
